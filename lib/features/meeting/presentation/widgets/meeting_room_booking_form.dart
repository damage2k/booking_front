...
import 'package:booking_front/features/map/presentation/providers/date_provider.dart';
...
import 'package:booking_front/shared/ui/time_field.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:intl/intl.dart';
import '../../../settings/presentation/providers/application_settings_providers.dart';

class MeetingRoomBookingForm extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MeetingRoomBookingForm> createState() =>
      _MeetingRoomBookingFormState();
}

class _MeetingRoomBookingFormState
    extends ConsumerState<MeetingRoomBookingForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return settingsAsync.when(
      ...
      data: (settings) {
        final startLimit =
            settings.get<String>("BOOKING_ROOMS_ALLOWED_START_TIME") ?? "09:00";
        final endLimit =
            settings.get<String>("BOOKING_ROOMS_ALLOWED_END_TIME") ?? "18:00";
